...
namespace Lab04.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var schoolDbContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Learner);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["LearnerId"] = new SelectList(_context.Set<Learner>(), "LearnerId", "LearnerId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,CourseId,LearnerId,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["LearnerId"] = new SelectList(_context.Set<Learner>(), "LearnerId", "LearnerId", enrollment.LearnerId);
            return View(enrollment);
        }
